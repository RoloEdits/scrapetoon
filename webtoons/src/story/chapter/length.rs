...
/// # Errors
pub fn parse(html: &Html) -> Result<u32> {
...
mod parse_chapter_length {
	...
	<img src="https://webtoon-phinf.pstatic.net/20200328_24/1585335418930bKIS5_JPEG/15853354189049526.jpg?type=q90"
        ...
        const IMAGE: &str = r##"<img src="https://webtoons-static.pstatic.net/image/bg_transparency.png" width="700" height="1149.0" alt="image" class="_images" data-url="https://webtoon-phinf.pstatic.net/20200706_31/1594020963279RqH1M_JPEG/159402096033266209.jpg?type=q90" rel="nofollow" ondragstart="return false;" onselectstart="return false;" oncontextmenu="return false;">"##;

        let html = Html::parse_document(IMAGE_LIST);
        let html_1 = Html::parse_document(IMAGE);

        let result = parse(&html).unwrap();
        let result_1 = parse(&html_1).unwrap();

        assert_eq!(result, 12_210);
        assert_eq!(result_1, 1149);
    }
}
